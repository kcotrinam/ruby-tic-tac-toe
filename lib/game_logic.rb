...
# Create a method to check diagonals, rows and columns
  # You can optimize the number of cases to just 4, if you know in which row you are playing, if you check according to your current position
